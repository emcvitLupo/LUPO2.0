...
const targetStr = `                            {/* Dati Campionamento Disposti Orizzontalmente per Ottimizzare lo Spazio */}
                            <div className="col-span-12 p-3 bg-white grid grid-cols-2 md:grid-cols-5 gap-3.5 text-[9.5px]">
                              ...
                              <div>
                                <span className="text-[7.5px] font-bold text-slate-400 uppercase block">Campionamento</span>
                                <span className="text-slate-800 font-medium block">{previewReportAcc.campionatoDa || 'A cura del Cliente'}</span>
                              </div>
                              <div className="md:col-span-3">
                                <span className="text-[7.5px] font-bold text-slate-400 uppercase block">Procedura di Campionamento e Informazioni Cliente</span>
...
const replaceStr = `                            {/* Dati Campionamento Disposti Orizzontalmente per Ottimizzare lo Spazio */}
                            <div className="col-span-12 py-2 px-1 bg-white grid grid-cols-2 md:grid-cols-5 gap-y-2 gap-x-2 text-[9px]">
                              <div>
                                <span className="text-[7px] font-bold text-slate-400 uppercase block">N. Campione</span>
                                <span className="font-mono font-bold text-slate-850 block">{previewReportAcc.codiceAccettazione}</span>
                              </div>
                              <div>
                                <span className="text-[7px] font-bold text-slate-400 uppercase block">Ricevimento</span>
                                <span className="text-slate-800 font-medium block">{previewReportAcc.dataAccettazione} {previewReportAcc.oraRicevimento ? \`\${previewReportAcc.oraRicevimento}\` : ''}</span>
                              </div>
                              <div>
                              ...
                              <div>
                                <span className="text-[7px] font-bold text-slate-400 uppercase block">Fine Prove</span>
                                <span className="font-mono text-slate-800 font-medium block">{previewReportAcc.dataTermineProva || previewReportAcc.consegnaPrevista || todayStr}</span>
                              </div>
                              <div>
                                <span className="text-[7px] font-bold text-slate-400 uppercase block">Cat. Merceologica</span>
                                <span className="text-slate-800 font-normal block leading-tight truncate">{currentCategory}</span>
                              </div>

                              <div className="md:col-span-2">
                                <span className="text-[7px] font-bold text-slate-400 uppercase block">Desc. Campione</span>
                                <span className="text-slate-800 font-medium block leading-tight truncate">{previewReportAcc.descrizioneCampione}</span>
                              </div>
                              <div className="md:col-span-2">
                                <span className="text-[7px] font-bold text-slate-400 uppercase block">Etichetta</span>
                                <span className="text-slate-700 font-medium italic block leading-tight truncate">{previewReportAcc.etichettaCampione || 'N.A.'}</span>
                              </div>
                              <div>
                                <span className="text-[7px] font-bold text-slate-400 uppercase block">Quantità/Imball.</span>
                                <span className="text-slate-800 font-medium block truncate">{previewReportAcc.quantitaCampione || 'N/A'} - {previewReportAcc.imballaggio || 'Bott. idonea'}</span>
                              </div>
                              ...
                              <div className="md:col-span-5 flex flex-wrap gap-x-4 gap-y-1">
                                <div>
                                  ...
                                  <span className="text-slate-800 font-medium inline-block">{previewReportAcc.campionatoDa || 'A cura del Cliente'}</span>
                                </div>
                                <div>
                                  <span className="text-[7px] font-bold text-slate-400 uppercase inline-block mr-1">Procedura:</span>
                                  <span className="text-slate-600 italic inline-block">{previewReportAcc.proceduraCampionamento || 'Non dichiarata'}</span>
                                </div>
                                <div>
                                  <span className="text-[7px] font-bold text-slate-400 uppercase inline-block mr-1">Info Cliente:</span>
                                  <span className="text-slate-600 italic font-medium inline-block">{previewReportAcc.informazioniCliente || 'N.A.'}</span>
                                </div>
                              </div>
                            </div>`;
...
console.log('patched details compact');
