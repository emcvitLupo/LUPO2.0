...
-- =========================================================================
-- CONFIGURAZIONE ROW LEVEL SECURITY (RLS) E POLICY DI SICUREZZA
-- =========================================================================

-- Assicuriamo la presenza della tabella 'profili' (Collegata a Supabase Auth)
...
-- POLICY PER TUTTE LE TABELLE (ACCESSO COMPLETO AGLI UTENTI AUTENTICATI)
